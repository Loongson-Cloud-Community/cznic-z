// Code generated by 'ccgo -lmodernc.org/z/lib -o internal/minigzip_linux_arm.go -trace-translation-units /tmp/go-generate-zlib-998366148/cdb.json minigzip64', DO NOT EDIT.
...
func main1(tls *libc.TLS, argc int32, argv uintptr) int32 { /* minigzip.c:556:5: */
	...
	prog = *(*uintptr)(unsafe.Pointer(argv + uintptr(0)*4))
	bname = libc.Xstrrchr(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(0)*4)), '/')
	if bname != 0 {
		bname++
	} else {
		bname = *(*uintptr)(unsafe.Pointer(argv + uintptr(0)*4))
	}
	argc--
	argv += 4
