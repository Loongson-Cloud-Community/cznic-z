// Code generated by 'ccgo -lmodernc.org/z/lib -o internal/example_linux_386.go -trace-translation-units /tmp/go-generate-zlib-908793443/cdb.json example64', DO NOT EDIT.
...
func main1(tls *libc.TLS, argc int32, argv uintptr) int32 { /* example.c:545:5: */
	...
	*(*uLong)(unsafe.Pointer(bp + 24 /* comprLen */)) = (uint32(10000) * uint32(unsafe.Sizeof(int32(0)))) // don't overflow on MSDOS
	...
	test_gzio(tls, func() uintptr {
		if argc > 1 {
			return *(*uintptr)(unsafe.Pointer(argv + uintptr(1)*4))
		}
